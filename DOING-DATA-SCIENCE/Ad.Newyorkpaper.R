...
library(ggplot2)
ggplot(data1, aex(x=Impressions, fill=agecat))
        +geom_histogram(binwidth=1)
ggplot(data1, aex(x=agecat, y= Impressions, fill= agecat))
        +geom_boxplot()
...
data1$scode[data1$Impressions >0] <- "Clicks"

#
data1$code <- factor(data1$scode)
head(data1)
